...
<div class="row">
			...
			<?php
	                           ...
	                           // $nomor = 0;
	                            ...
	                            //    $nomor++;
							?> 
			<a href="?open=cetak_hasil_amasalah"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-print"></span> Cetak</button></a>
            <a href="?open=amasalah_data_personil"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-repeat"></span> Back</button></a>
						...
						<tbody>
							...
							?>	
								<tr>
									...
									<td style="background-color: #ffffff" align="left"><textarea rows="10" readonly=""><?php echo $data['ident_masalah'];?></textarea></td>
									<td style="background-color: #ffffff" align="left"><textarea rows="10" readonly=""><?php echo $data['harapan'];?></textarea></td>
									<td style="background-color: #ffffff" align="left"><textarea rows="10" readonly=""><?php echo $data['penanganan'];?></textarea></td>
									<td style="background-color: #ffffff" align="left"><textarea rows="10" readonly=""><?php echo $data['dnmk_psi'];?></textarea></td>
									<td style="background-color: #ffffff" align="left"><textarea rows="10" readonly=""><?php echo $data['saran'];?></textarea></td>
									<td style="background-color: #ffffff" align="left"><textarea rows="10" readonly=""><?php echo $data['nama_konselor'];?></textarea></td>
