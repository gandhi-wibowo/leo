				...
				<table id="lookup" class="table table-bordered">
					<thead>
							<tr>
								...
								<th style="background-color: #ffffff">Daftar PKP</th>	
							</tr>
						</thead>
						<tbody>
							<?php
							...
							?>	
								<tr>
									...
									<td style="background-color: #ffffff" align="center">
                                    	<a href="?open=pkp_add&nrp=<?php echo $data['nrp'];?>" title="Daftar PKP" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></a>
                                    </td>
								</tr>
							<?php
								}
