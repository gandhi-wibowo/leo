    ...
    class FPDF_AutoWrapTable extends FPDF {
        ...
        public function rptDetailData () {
            ...
            $this->SetX($left); $this->Cell(0, 25, 'SISTEM E - COUNSELING', 0, 1,'C');
            $this->SetFont("Arial", "B", 12);
            $this->SetX($left); $this->Cell(0, 15, 'LAPORAN DATA PESERTA KONSELING', 0, 1,'C');
            ...
            $this->SetX($left += 30); $this->Cell(80, $h, 'Nrp', 1, 0, 'C',true);
            $this->SetX($left += 80); $this->Cell(150, $h, 'Nama', 1, 0, 'C',true);
            $this->SetX($left += 150); $this->Cell(170, $h, 'Jabatan', 1, 0, 'C',true);
            $this->SetX($left += 170); $this->Cell(80, $h, 'Pangkat', 1, 0, 'C',true);
            $this->SetX($left += 80); $this->Cell(80, $h, 'Tgl', 1, 0, 'C',true);
            $this->SetX($left += 80); $this->Cell(180, $h, 'Rekomendasi', 1, 1, 'C',true);
            //$this->Ln(20);
     
            $this->SetFont('Arial','',10);
            $this->SetWidths(array(30,80,150,170,80,80,180));
    ...
    $data = array();
    $query = "SELECT tblpeserta.*, tbluser.* FROM tblpeserta
    LEFT JOIN tbluser ON tblpeserta.kd_user = tbluser.kd_user
    WHERE ( tgl BETWEEN '".ubah_tgl2($tgl1)."' AND '".ubah_tgl2($tgl2)."')";
